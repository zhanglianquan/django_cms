...
$(document).ready(function(){
    ...
    //中间的界面部分
    $("#center-column").load("../../static/templates/main.html");
});
			...
			$.each(item_obj.child_menu, function(j, item_obj_child) {
				$.each(item_obj_child.child_menu, function(k, item_obj_child2) {
					if(item_obj_child2.id == id) {
						...
						$("#center-column").load("../../static/templates/data_manager/" + item_obj_child2.url + "?random=" + Math.random());
					}
				});
			});
		});
